SCENARIO_CONTEXT = {
  "single-enqueue": {
    ...
    "good_number": "`<= 20 ms` for request-path enqueue on the 10k local benchmark",
    "use_case": (
  ...
  "bulk-enqueue": {
    ...
    "good_number": "`>= 5,000 jobs/sec` for 10k independent immediate jobs",
  ...
  "scheduled-promotion": {
    ...
    "good_number": "`>= 5,000 rows/sec` for a 10k due-row promotion burst",
  ...
  "recurring-scale": {
    ...
    "good_number": "`<= 0.050 seconds` for a no-op poll over 10k not-due schedules",
  ...
  "worker-drain": {
    ...
    "good_number": "`>= 250 jobs/sec` for draining 10k no-op ready jobs",
  ...
  "concurrency-contention": {
    ...
    "good_number": "`>= 25 jobs/sec` for a 10k serialized hot-key drain",
  ...
  "ordered-selector-claim": {
    ...
    "good_number": "`>= 50 jobs/sec` for a 10k exact-selector drain",
